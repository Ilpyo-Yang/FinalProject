...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $("button#btnUpdate").click(function(){
         ...
         frm.method = "POST";
         frm.action = "<%= ctxPath%>/cnotice_editEnd.opis";
         frm.submit();   
      });
	...
	<form name="editFrm" id="editFrm"> 
      ...
      <table id="table">
		 ...
		 <tr style="display: none;"><!-- 글번호 넘기기용 -->
		 	<th>글번호</th>
		 	<td>
                <input type="text" name="cnotice_seq" value="${requestScope.cnoticevo.cnotice_seq}" readonly/>   
            </td>
		 </tr>
         <tr>
            <th>제목</th>
         ...
         <tr>
            <th>내용</th>
            <td>
               <textarea rows="10" cols="100" style="width: 95%; height: 450px;" name="ccontent" id="ccontent">${requestScope.cnoticevo.ccontent}</textarea>       
            </td>
         </tr>
