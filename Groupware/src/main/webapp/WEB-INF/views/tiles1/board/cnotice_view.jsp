...
<div style="padding-left: 10%;">
   ...
   <c:if test="${not empty requestScope.boardvo}">
   	 <table id="table">
   		<tr>
            <th>글번호</th>
            <td>${requestScope.boardvo.cnotice_seq}</td>
         </tr>
         <tr>
            <th>작성자</th>
            <td>관리자</td>
         ...
         <tr>
            <th>제목</th>
            <td>${requestScope.boardvo.ctitle}</td>
         </tr>
         <tr>
            <th>내용</th>
            <td>
            	<p style="word-break: break-all;">${requestScope.boardvo.ccontent}</p>
            <%-- 
         ...
         <tr>
            <th>조회수</th>
            <td>${requestScope.boardvo.chit}</td>
         </tr>
         <tr>
            <th>날짜</th>
            <td>${requestScope.boardvo.cwritedate}</td>
         </tr>
   	 </table>
