            ...
            if (messageVO.getType().equals("all")) { 
                ...
                if (!wsession.getId().equals(webSocketSession.getId())) {  
                    ...
                    webSocketSession.sendMessage(
                            new TextMessage("<span>"+wsession.getRemoteAddress().getAddress().getHostAddress()+"</span>&nbsp;[<span style='font-weight:bold; cursor:pointer;' class='loginuserName'>" +loginuser.getMbr_name()+ "</span>]" + " ▶ " + messageVO.getMessage()));  
                }
            } 
